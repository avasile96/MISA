...
def computeAtlasProb(export):
    train_indexes = ['000', '01', '02', '06', '07', '08', '09', '10', 
    ...
    if (export=='save'):
        output_prob_atlas_WM        = sitk.GetImageFromArray(prob_atlas_CSF/1)
        output_prob_atlas_CSF         = sitk.GetImageFromArray(prob_atlas_WM/2)
