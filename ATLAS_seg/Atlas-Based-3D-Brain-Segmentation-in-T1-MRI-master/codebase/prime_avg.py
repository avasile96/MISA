...
from prime_aux import computeAtlasProb, computeTissueModels, labelPropg, all_labelPropg, computeMNIAtlasProb, compute_avg_train
from em_aux import dice_metric
from EM_main_final import segmentEM
...
# # Visualize Independent Tissue Models, in this part there is a big BUG line 20
# plt.figure()
...
predicted_mask00 = labelPropg(CSF="../results/testing_results/transformed_labels_avg/CSF/"+index+"/result.mhd", WM="../results/testing_results/transformed_labels_avg/WM/"+index+"/result.mhd", 
                              GM="../results/testing_results/transformed_labels_avg/GM/"+index+"/result.mhd",   mask="../data/testing-set/testing-mask/1"+index+"_1C.nii.gz",
...
predicted_mask10 = labelPropg(CSF="../results/testing_results/transformed_labels_avg/CSF/"+index+"/result.mhd", WM="../results/testing_results/transformed_labels_avg/WM/"+index+"/result.mhd", 
                              GM="../results/testing_results/transformed_labels_avg/GM/"+index+"/result.mhd",   mask="../data/testing-set/testing-mask/1"+index+"_1C.nii.gz",
...
## MNI PROBABILITY ATLASES # alex
# computeMNIAtlasProb(export='save')

# ### AVG PROBABILITY ATLAS
# compute_avg_train(export = 'save')
