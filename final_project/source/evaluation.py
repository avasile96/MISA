# -*- coding: utf-8 -*-
"""
Created on Wed Jan  5 21:13:07 2022
...
if __name__ ==  '__main__':
    ...
    # folder = 'C:\\Users\\omanu\\OneDrive - campus.udg.edu\\Temporary'
    gt = os.path.join(folder, 'labels_unet_clean.png')
    pred = os.path.join(folder, 'labels.png')
...
#    sitk.WriteImage(img, file_name)
    ...
    haus = compute_hausdorff_distance(im1, im2)
    print(haus)
